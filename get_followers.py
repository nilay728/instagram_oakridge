...
options.add_extension("/Users/gyanprakash/Downloads/instagram_oakridge/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/gyanprakash/Downloads/{}_followers.csv /Users/gyanprakash/Downloads/instagram_oakridge/accounts'.format(account))
        except:
